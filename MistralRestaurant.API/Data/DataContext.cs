...
namespace MistralRestaurant.API.Data
{
    public class DataContext : DbContext
    {
        ...
        public DbSet<IngredientRecipe> IngredientaAndRecipes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<RecipeCategory>().HasData(
                ...
                new RecipeCategory { Id = 8, Name = "Grill" },
            ...
            modelBuilder.Entity<Ingredient>().HasData(
                ...
                new Ingredient { Id = 12, Name = "Tijesto", MeasureType = MeasureType.Kg, PacketQuantity = 15, PacketQuantityPrice = 15 }
